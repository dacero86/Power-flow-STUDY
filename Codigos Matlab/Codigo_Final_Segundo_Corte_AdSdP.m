...
CI = xlsread('Datos.xlsx','Ejercicio2');
Voltajes = CI(:,3);
Angulos = CI(:,4);
...
% matruz Ybus
Y=[(8.9853-44.8360i) (-3.8156+19.0781i) (-5.1696+25.8478i)  0;(-3.8156+19.0781i) (8.9853-44.8360i) 0 (-5.1696+25.8478i);(-5.1696+25.8478i) 0 (8.1933-40.8638i) (-3.0237+15.1185i);0 (-5.1696+25.8478i) (-3.0237+15.1185i) (8.1933-40.8638i)];
Ya=angle(Y);
...
o1=0;
O1=double(o1);
Pesp=[-1.7 -2 (3.18-0.80) -1.2394 -1.2394 -0.4958]';
...
for i=1:1:ci
    ...
    poti(i) = Qkk(EliminacionV(i));
    Ve(i) = V(EliminacionO(i));
    Qe(i) = DQ(EliminacionO(i));
end
